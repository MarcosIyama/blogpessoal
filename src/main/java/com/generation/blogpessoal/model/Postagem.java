...
public class Postagem {
	...
	@NotBlank(message = "O atributo título é Obrigatório.") // "Título da Postagem"
	@Size(min = 5, max = 100, message = "O título deve conter no mínimo 5 e no máximo 100 caracteres.")
	private String titulo;
	
	@NotBlank(message = "O atributo texto é Obrigatório.")
	@Size(min = 5, max = 1000, message = "O título deve conter no mínimo 10 e no máximo 1000 caracteres.")
